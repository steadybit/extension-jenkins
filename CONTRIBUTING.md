...
| `$ make container` | Build the container image (`extension-jenkins:latest`) using Docker buildx.                           |
...
## Releasing Helm Chart Changes
 ...
 1. Update the version number in the [Chart.yaml](./charts/steadybit-extension-jenkins/Chart.yaml)
...
```
> Releasing charts...
    Error: error creating GitHub release steadybit-extension-jenkins-1.0.0: POST https://api.github.com/repos/steadybit/extension-jenkins/releases: 422 Validation Failed [{Resource:Release Field:tag_name Code:already_exists Message:}]
```
